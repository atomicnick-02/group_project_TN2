    ...
    \begin{column}{0.54\textwidth}
      ...
      \begin{itemize}
        \item Wrap-safe angular features
          $\phi=[\sin q,\cos q,\dots,\tilde{\dot q}]\in\mathbb{R}^{6}$
        \item Min--max normalise to $[-1,1]$ (stats saved)
